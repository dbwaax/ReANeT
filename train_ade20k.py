...
from model.GANMRF import RegionNet_ViT
from matric_single import Evaluation_ade20k
from model.GANMRF_dup import CEANet_res34,CEANet_res50,CEANet_res101
...
parser.add_argument("--num_classes",default=151)
...
parser.add_argument("--train_set",default=r'./scheme_set/train_ade20k.txt')
parser.add_argument("--val_set",default=r'./scheme_set/val_ade20k.txt')
...
for epoch in range(1,args.Epoch+1):
    ...
    if(epoch % 1 == 0 and epoch!=0):
        generate.eval()
        pa,recall,IoU,mIoU,eval_loss = Evaluation_ade20k(generate=generate,dataloader=dl_val,device=args.device)
        mPa = np.mean(pa)
